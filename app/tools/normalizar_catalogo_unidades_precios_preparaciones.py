...
PRICE_MAP = {
 ...
 'AJO':5.50,'ALBAHACA':1.80,'ALCACHOFA':3.80,'ALCAPARRAS':7.50,'ALGAS NORI':160.71,'ALMEJA':14.00,'ANCHOA':18.00,'APIO':1.80,
 ...
 'CALABAZA':1.70,'CALAMAR':12.00,'CALDO/STOCK LIQUIDO':1.80,'CANELA':16.00,'CARNE PICADA VACUNO':9.50,'CEBOLLA':1.35,'CEBOLLINO':1.60,
 'CERDO LOMO':6.80,'CERVEZA PARA COCINAR':1.60,'CHAMPINON':3.20,'CHOCOLATE NEGRO':7.50,'CHORIZO':7.50,'CILANTRO':1.50,'CLAVO':22.00,
 ...
 'ENELDO':1.80,'ENTRECOT':18.00,'ESPINACA CONGELADA':2.20,'ESPINACA FRESCA':3.50,'ESPARRAGO VERDE':6.50,'FIDEOS':2.20,'FIDEOS UDON':12.73,
 ...
 'MAIZ DULCE':3.93,'MEJILLON':4.50,'MENTA':1.80,'MERLUZA':11.50,'MORCILLA':6.00,'MOSTAZA DIJON':5.50,'NARANJA':1.60,
 ...
 'PEPINILLOS':3.60,'PEPINO':1.60,'PERA':2.10,'PEREJIL':0.80,'PIMENTON DULCE':12.00,'PIMENTON PICANTE':12.00,'PIMIENTA NEGRA':18.00,
 ...
 'QUESO PARMESANO':18.00,'QUINOA BLANCA':5.37,'RAMEN NOODLES':10.76,'REMOLACHA':1.80,'ROMERO':1.60,'RUCULA':7.00,'SAL':0.55,
 ...
 'TOMILLO':1.60,'TORTILLA DE TRIGO':5.62,'VINAGRE BALSAMICO':4.50,'VINAGRE VINO':1.60,'VINO BLANCO COCINA':2.20,'VINO TINTO COCINA':2.20,
 'YOGUR NATURAL':2.20,'YUCA':3.29,'YUCA CONGELADA':4.10,'ZANAHORIA':1.35,
 'AGUACHILES':7.00,'AGUACHILE':7.00,
}
FRESH_HERBS_MANOJO = {'ALBAHACA','CILANTRO','CEBOLLINO','MENTA','PEREJIL','HIERBABUENA','ENELDO','ROMERO','TOMILLO','CEBOLLETA'}
HERB_MANOJO_PRICE = {'ALBAHACA':1.80,'CILANTRO':1.50,'CEBOLLINO':1.60,'MENTA':1.80,'PEREJIL':0.80,'HIERBABUENA':1.80,'ENELDO':1.80,'ROMERO':1.60,'TOMILLO':1.60,'CEBOLLETA':1.20}
...
def est_price(name, area=''):
    n = norm(name)
    if n in HERB_MANOJO_PRICE: return HERB_MANOJO_PRICE[n], 'manojo_hierba_fresca'
